...
$assert(
    $template->toElement() !== $templateRoot,
    'Template events must invalidate dependency-skipped component trees after direct state mutation.',
);
Runtime::shutdown();
...
$assert(
    \Pam\Native\Protocol::SDK_VERSION === '1.0.23',
    'The runtime SDK contract must match the stable 1.0.23 package release.',
);
